...
# route to the delete business route
@jwt_required
def delete_business(current_user, business_id):
    """Delete a business"""
    delete_this_business = Business.delete_business(business_id=business_id, business_owner_id=current_user)
...
def edit_business(current_user, business_id):
    ...
    if business:
        if business.business_owner_id == current_user.user_id:
